...
export default function AdminPanel() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center font-sans antialiased text-slate-100">
        <div className="relative flex items-center justify-center">
          <div className="w-12 h-12 rounded-full border-2 border-sky-500/20 border-t-sky-500 animate-spin"></div>
        </div>
        <p className="mt-4 text-xs font-semibold uppercase tracking-widest text-slate-400">Loading Session...</p>
      </div>
    );
  }
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center font-sans antialiased p-4 relative overflow-hidden">
        {/* Subtle decorative mesh gradients for premium feel */}
        ...
        <Card className="w-full max-w-md bg-slate-900/80 border-slate-800 backdrop-blur-xl shadow-2xl rounded-none relative z-10 overflow-hidden">
          <div className="h-1 bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-500" />
          
          <CardHeader className="text-center pt-8 pb-6">
            <div className="mx-auto w-12 h-12 rounded-lg bg-sky-500/10 border border-sky-500/20 flex items-center justify-center mb-4">
              <ShieldAlert className="w-6 h-6 text-sky-400" />
            </div>
            <CardTitle className="text-2xl font-bold text-white tracking-tight">Sangronyx Console</CardTitle>
            <CardDescription className="text-slate-400 text-xs mt-1.5 uppercase tracking-wider font-semibold">
              Central Website Operations
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6 pb-8">
            <div className="text-center px-4">
              <p className="text-sm text-slate-300 leading-relaxed">
                Access to the administration portal is restricted. Please authenticate with an authorized Google account.
              </p>
            </div>
            ...
            <div className="space-y-3 pt-2">
              <Button
                ...
                className="w-full bg-white hover:bg-slate-50 text-slate-900 border border-slate-200 py-6 font-semibold flex items-center justify-center gap-3 transition-all rounded-none hover:shadow-lg active:scale-[0.99]"
              >
                {/* SVG Google Logo */}
