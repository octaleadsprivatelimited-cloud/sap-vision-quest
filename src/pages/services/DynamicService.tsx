...
const DynamicService = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans antialiased text-[#1d1d1d] flex flex-col">
      <SEO 
        title={`${service.title} | SAP Services | Sangronyx`}
              ...
              <div className="lg:col-span-7 space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-xs md:text-sm text-neutral-600 leading-relaxed">
                    We deliver intelligent, scalable, and future-ready SAP solutions that drive operational excellence, innovation, and business growth. Leverage our expert consulting framework to accelerate your roadmap.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="bg-[#f5f5f5] border border-neutral-200 p-6 md:p-8 space-y-4 rounded-none">
                  ...
                  <p className="text-xs text-neutral-600 leading-relaxed">
                    Connect with our certified SAP solution architects to discuss your specific business process transformation requirements.
                  </p>
                  <div>
                    <Link to="/contact">
